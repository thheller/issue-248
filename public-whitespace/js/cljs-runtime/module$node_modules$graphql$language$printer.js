shadow$provide["module$node_modules$graphql$language$printer"] = function(global, process, require, module, exports) {
  ...
  var printDocASTReducer = {Name:function Name(node) {
    return node.value;
    ...
    return variable + ": " + type + wrap(" \x3d ", defaultValue);
    ...
    return join(["type", name, wrap("implements ", join(interfaces, " \x26 ")), join(directives, " "), block(fields)], " ");
  }), FieldDefinition:addDescription(function(_ref24) {
    var name = _ref24.name, args = _ref24.arguments, type = _ref24.type, directives = _ref24.directives;
    return name + wrap("(", join(args, ", "), ")") + ": " + type + wrap(" ", join(directives, " "));
  }), InputValueDefinition:addDescription(function(_ref25) {
    var name = _ref25.name, type = _ref25.type, defaultValue = _ref25.defaultValue, directives = _ref25.directives;
    return join([name + ": " + type, wrap("\x3d ", defaultValue), join(directives, " ")], " ");
  }), InterfaceTypeDefinition:addDescription(function(_ref26) {
    var name = _ref26.name, directives = _ref26.directives, fields = _ref26.fields;
    return join(["interface", name, join(directives, " "), block(fields)], " ");
  }), UnionTypeDefinition:addDescription(function(_ref27) {
    var name = _ref27.name, directives = _ref27.directives, types = _ref27.types;
    return join(["union", name, join(directives, " "), types && types.length !== 0 ? "\x3d " + join(types, " | ") : ""], " ");
    ...
    return join(["extend type", name, wrap("implements ", join(interfaces, " \x26 ")), join(directives, " "), block(fields)], " ");
    ...
    return join(["extend union", name, join(directives, " "), types && types.length !== 0 ? "\x3d " + join(types, " | ") : ""], " ");
