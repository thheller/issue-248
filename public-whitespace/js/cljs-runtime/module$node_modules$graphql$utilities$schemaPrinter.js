shadow$provide["module$node_modules$graphql$utilities$schemaPrinter"] = function(global, process, require, module, exports) {
  ...
  function printUnion(type, options) {
    return printDescription(options, type) + ("union " + type.name + " \x3d " + type.getTypes().join(" | "));
  }
  ...
  function printInputValue(arg) {
    ...
    if (!(0, _isInvalid2.default)(arg.defaultValue)) {
      argDecl += " \x3d " + (0, _printer.print)((0, _astFromValue.astFromValue)(arg.defaultValue, arg.type));
    }
    return argDecl;
  }
  ...
  function breakLine(line, maxLen) {
    ...
    var parts = line.split(new RegExp("((?: |^).{15," + (maxLen - 40) + "}(?\x3d |$))"));
    if (parts.length < 4) {
      return [line];
    }
